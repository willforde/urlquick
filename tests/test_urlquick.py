...
class TestCacheHandler(unittest.TestCase):
    class create(object):
        def __init__(self, url, max_age=14400, body=u"", headers=None, status=200, reason=u"OK"):
            ...
            hash_url = urlquick.CacheRecord.hash_url(url)
            path = urlquick.CacheRecord.cache_dir()
            ...
            print(cache_file)
            self.cache = urlquick.CacheRecord(hash_url, max_age)
    ...
    def test_isfilefresh(self):
        fresh = urlquick.CacheRecord.isfilefresh(__file__, 0)
        self.assertFalse(fresh)
        fresh = urlquick.CacheRecord.isfilefresh(__file__, 999999999)
    ...
    def assert_url_hash_Equal(self, url_hash, check):
        self.assertEqual(url_hash, urlquick.CacheRecord.safe_path(check))

    def test_hash_url_unicode(self):
        hashurl = urlquick.CacheRecord.hash_url(u"https://httpbin.org/get")
        self.assert_url_hash_Equal(hashurl, "cache-eadd3f1d0242ca5f05c4c7b89188df7eadc72976")

    def test_hash_url_bytes(self):
        hashurl = urlquick.CacheRecord.hash_url(b"https://httpbin.org/get")
        self.assert_url_hash_Equal(hashurl, "cache-eadd3f1d0242ca5f05c4c7b89188df7eadc72976")

    def test_hash_url_data_unicode(self):
        hashurl = urlquick.CacheRecord.hash_url("https://httpbin.org/get", data=u"data")
        self.assert_url_hash_Equal(hashurl, "cache-da991148ea2a035a6f4204b33265ac70b42b0c4b")

    def test_hash_url_data_bytes(self):
        hashurl = urlquick.CacheRecord.hash_url("https://httpbin.org/get", data=b"data")
        self.assert_url_hash_Equal(hashurl, "cache-da991148ea2a035a6f4204b33265ac70b42b0c4b")
    ...
    def test_save_TypeError(self):
        ...
        url = urlquick.CacheRecord.hash_url("https://httpbin.org/get")
        cache = urlquick.CacheRecord(url)
    ...
    def test_save_path_uni(self):
        ret = urlquick.CacheRecord.safe_path(u"testpath")
